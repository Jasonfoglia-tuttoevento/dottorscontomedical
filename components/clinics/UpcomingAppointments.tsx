    ...
    <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center justify-between">
          ...
          <Link href="/dashboard/clinic/appointments" className="text-[#0D47A1] hover:text-[#0B3B86] text-sm font-semibold">
            Vedi tutti
          </Link>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-gray-200">
        <Link
          ...
          className="flex items-center justify-center gap-2 text-[#0D47A1] hover:text-[#0B3B86] font-semibold text-sm"
        >
