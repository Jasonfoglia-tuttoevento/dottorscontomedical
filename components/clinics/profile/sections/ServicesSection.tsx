  ...
  return (
    <section id="services" className="bg-white rounded-xl border border-gray-200 shadow-sm">
        ...
        <div className="flex items-center justify-between">
          ...
          {!showAddForm && (
            <button
              ...
              className="flex items-center gap-2 px-4 py-2.5 bg-[#0D47A1] text-white rounded-lg font-semibold hover:bg-[#0B3B86] transition text-sm"
            >
      ...
      <div className="p-6 space-y-6">
        {/* Add/Edit Form */}
        {showAddForm && (
          <div className="bg-[#E6FAF5] border border-[#99E7DB] rounded-xl p-6">
            ...
            <form onSubmit={editingId ? handleUpdate : handleAdd} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      className="w-full pr-4 py-3 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#0D47A1]"
                      placeholder="500"
                      min="0"
                      step="0.01"
                    />
              ...
              <div className="flex justify-end gap-3 pt-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex items-center gap-2 px-4 py-2.5 bg-[#0D47A1] text-white rounded-lg font-semibold hover:bg-[#0B3B86] transition text-sm disabled:opacity-50"
                >
        ...
        {services.length > 0 ? (
          <div className="space-y-3">
            {services.map((service) => (
              <div
                key={service.id}
                className="flex items-start justify-between p-4 border border-gray-200 rounded-xl hover:border-[#99E7DB] hover:shadow-sm transition"
              >
                ...
                <div className="flex items-center gap-2 ml-4">
                  ...
                  <button
                    ...
                    className="p-2 text-gray-500 hover:text-[#0D47A1] hover:bg-[#E6FAF5] rounded-lg transition"
                    title="Elimina"
                  >
          ...
          !showAddForm && (
            <div className="text-center py-12">
              ...
              <button
                onClick={() => setShowAddForm(true)}
                className="inline-flex items-center gap-2 px-4 py-2.5 bg-[#0D47A1] text-white rounded-lg font-semibold hover:bg-[#0B3B86] transition text-sm"
              >
                <Plus className="w-4 h-4" />
